...
class acme_DP(Node):
    def __init__(self):
        super().__init__('acme_dp', namespace='/wamv_v2')
        self.declare_parameter('veh', 'wamv_v2')
        ...
        self.policy_network = tf.saved_model.load("/home/arg/ros2_gazebo/ros2_ws/install/veh_model/share/veh_model/models/wamv_v2/0.15_dp_model/snapshots/policy")
