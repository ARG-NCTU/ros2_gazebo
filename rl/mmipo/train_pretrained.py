...
initial_learning_rate = 1e-5  # Slightly lower learning rate for fine-tuning
...
model = MMIPO.load("./logs/mmipo_math_usv2024-12-21_30000000_steps.zip", env=env)
...
model.tensorboard_log = 'tb_mmipo'
...
model.learn(
    ...
    tb_log_name='tb_mmipo_fine_tune_usv2', 
    callback=checkpoint_callback
    )

# Save the fine-tuned model
model.save("mmipo_usv2_fine_tuned")
env.close()
