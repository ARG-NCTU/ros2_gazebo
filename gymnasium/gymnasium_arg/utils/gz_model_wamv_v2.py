        ...
        launch_script = [
            launch_ros.actions.Node(
                ...
                arguments=[
                    ...
                    f"/{self.name}/joint/left_engine_propeller_joint/cmd_thrust@std_msgs/msg/Float64]gz.msgs.Double",
                    f"/{self.name}/joint/left_front_engine_propeller_joint/cmd_thrust@std_msgs/msg/Float64]gz.msgs.Double",
                    f"/{self.name}/joint/right_engine_propeller_joint/cmd_thrust@std_msgs/msg/Float64]gz.msgs.Double",
                    f"/{self.name}/joint/right_front_engine_propeller_joint/cmd_thrust@std_msgs/msg/Float64]gz.msgs.Double",
                ],
