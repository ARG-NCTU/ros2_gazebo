    ...
    def __init__(self, world, name, path, pose: Pose, info={'veh':'wamv_v1', 'maxstep': 4096, 'max_thrust': 15*746/9.8, 'hist_frame': 5}):
        ...
        launch_script = [
            launch_ros.actions.Node(
                ...
                parameters=[],
                arguments=[
                    f"/world/{world}/model/{name}/link/imu_link/sensor/imu_sensor/imu@sensor_msgs/msg/Imu[ignition.msgs.IMU",
                    f"/{name}/joint/left/thruster/cmd_thrust@std_msgs/msg/Float64]ignition.msgs.Double",
                    f"/{name}/joint/left_front/thruster/cmd_thrust@std_msgs/msg/Float64]ignition.msgs.Double",
                    f"/{name}/joint/right/thruster/cmd_thrust@std_msgs/msg/Float64]ignition.msgs.Double",
                    f"/{name}/joint/right_front/thruster/cmd_thrust@std_msgs/msg/Float64]ignition.msgs.Double",
